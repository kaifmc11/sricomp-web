...
import { FaDesktop, FaLaptop, FaStar,FaArrowRight, FaTv, FaMicrochip, FaMemory, FaHdd, FaMapMarkerAlt, FaPhone, FaClock, FaTabletAlt } from 'react-icons/fa';

const LenovoShowroom = () => {
  const laptops = [
    {
      id: 1,
      name: "Lenovo Legion 5 Pro",
      image: "https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6455/6455136ld.jpg",
      price: "₹92,999",
    ...
    },
    {
      ...
      image: "https://p1-ofp.static.pub/fes/cms/2023/05/30/gxs5c9ovq443ra9n4fvz1h8wdbakmp833888.png",
      price: "₹58,999",
    ...
    },
    {
      ...
      image: "https://ardes.bg/uploads/original/lenovo-ideapad-gaming-3-15-gen-6-346012.jpg",
      price: "₹61,999",
    ...
    },
    {
      id: 4,
      name: "Lenovo Yoga 7i",
      image: "https://tse4.mm.bing.net/th/id/OIP.xKlAR0BnzpSI5-Q1xpfcQwHaEh?pid=Api&P=0&h=180",
      price: "₹84,999",
    ...
    },
    {
      ...
      image: "https://www.notebookcheck.org/uploads/tx_nbc2/LenovoIdeaPadSlim5-15.JPG",
      price: "₹45,999",
    ...
    },
    {
      ...
      image: "https://tse2.mm.bing.net/th/id/OIP.h0HfYCdQD4OrZhaoOfh0tgHaEc?pid=Api&P=0&h=180",
      price: "₹2,24,999",
      originalPrice: "₹2,44,999",
      processor: "Intel Core i7-12800H",
      ram: "32GB DDR5",
      storage: "1TB SSD",
      graphics: "RTX A2000 8GB",
      display: "16\" 4K OLED",
  ...
  const productImages = [
    {
      ...
      description: "Legion series gaming powerhouses"
    },
    {
      title: "Business Laptops",
      image: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=400&h=300&fit=crop",
      description: "ThinkPad professional solutions"
    },
    {
      title: "Tablets & 2-in-1",
      image: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400&h=300&fit=crop",
      description: "Yoga convertible devices"
    },
    {
      title: "Desktop PCs",
      image: "https://images.unsplash.com/photo-1587831990711-23ca6441447b?w=400&h=300&fit=crop",
      description: "ThinkCentre desktop solutions"
    }
  ];
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-red-600 to-red-700 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-xl mb-8 max-w-4xl mx-auto leading-relaxed transform transition-all duration-1000 ease-out opacity-0 translate-y-8 animate-[fadeInUp_1s_0.6s_forwards]">
            Buy all model Lenovo Laptop, Desktop, Tablets, ThinkPad, & Accessories at Sri Computers, Pondicherry.
          </p>
          <div className="flex justify-center space-x-4 transform transition-all duration-1000 ease-out opacity-0 translate-y-8 animate-[fadeInUp_1s_0.8s_forwards]">
            <a 
              ...
              className="bg-white text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-red-50 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Shop Now
            </a>
            <a 
              href="tel:+919994678486"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-600 transform hover:scale-105 transition-all duration-300 hover:shadow-lg"
            >
              Contact Us
            </a>
          </div>
      ...
      <div className="bg-white py-16 transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards]">
            <h2 className="text-5xl font-bold text-gray-800 mb-4 transition-colors duration-300 hover:text-red-600">
              Lenovo Laptops
            </h2>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 transition-colors duration-300">
              Most Searched Lenovo Laptops in Pondicherry
            </h3>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto transition-colors duration-300">
              Here are some of the most wanted Lenovo Laptops in Chennai. In our Store, you can find all kinds of Lenovo laptops to fit your budget.
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center text-sm text-gray-700 transform transition-all duration-300 hover:translate-x-1">
                      <FaMicrochip className="w-4 h-4 mr-3 text-red-500 transition-colors duration-300" />
                    ...
                    <div className="flex items-center text-sm text-gray-700 transform transition-all duration-300 hover:translate-x-1">
                      <FaDesktop className="w-4 h-4 mr-3 text-blue-500 transition-colors duration-300" />
      ...
      {/* Special Lenovo Features Section */}
      <div className="bg-gradient-to-r from-red-600 to-red-700 py-16 text-white transition-all duration-500">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold mb-8 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards] transition-colors duration-300 hover:text-red-200">Why Choose Lenovo?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: FaLaptop,
                title: "ThinkPad Legacy",
                description: "Legendary business laptops trusted by professionals worldwide for reliability."
              },
              {
                icon: FaDesktop,
                title: "Legion Gaming",
                description: "Powerful gaming laptops designed for competitive gaming and performance."
              },
              {
                icon: FaTabletAlt,
                title: "Yoga Innovation",
                description: "Flexible 2-in-1 laptops that adapt to your work style and creativity needs."
              }
            ].map((item, index) => (
              <div key={index} className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm transform transition-all duration-500 hover:scale-105 hover:bg-white/20 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards]" style={{ animationDelay: `${index * 0.2}s` }}>
                ...
                <p className="text-red-100 transition-colors duration-300">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
