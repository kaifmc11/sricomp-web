...
const AsusShowroom = () => {
  const laptops = [
    {
      ...
      image: "https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6466/6466550cv1d.jpg",
      price: "₹94,999",
    ...
    },
    {
      ...
      image: "https://m.media-amazon.com/images/I/81DkONvgRVL._AC_SL1500_.jpg",
      price: "₹67,999",
      originalPrice: "₹77,999",
    ...
    },
    {
      ...
      image: "https://c.scdn.gr/images/sku_images/077442/77442153/20230619131732_e31ea979.jpeg",
      price: "₹58,999",
    ...
    },
    {
      ...
      image: "https://www.lbtechreviews.com/wp-content/uploads/2020/08/Zephyrus-G14_3.jpg",
      price: "₹1,12,999",
      originalPrice: "₹1,22,999",
    ...
    },
    {
      ...
      image: "https://laptopmedia.com/wp-content/uploads/2023/03/3-7-e1678204949389.jpg",
      price: "₹39,999",
    ...
    },
    {
      ...
      image: "https://s.yimg.com/uu/api/res/1.2/xkfLwk9UP79GGN4J4639Cg--~B/aD0xMTI1O3c9MjAwMDthcHBpZD15dGFjaHlvbg--/https://media-mbst-pub-ue1.s3.amazonaws.com/creatr-uploaded-images/2021-11/708a1340-4240-11ec-bdfb-225011f29bb8.cf.jpg",
      price: "₹1,89,999",
  ...
  const productImages = [
    {
      ...
      description: "ROG series gaming powerhouses"
    },
    {
      title: "Desktop PCs",
    ...
    },
    {
      ...
      description: "Premium motherboard solutions"
    }
  ];
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-gray-800 to-black text-white">
        <div className="absolute inset-0 bg-black opacity-30 transition-opacity duration-700"></div>
        <div className="relative max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-xl mb-8 max-w-4xl mx-auto leading-relaxed transform transition-all duration-1000 ease-out opacity-0 translate-y-8 animate-[fadeInUp_1s_0.6s_forwards]">
            Buy all model ASUS Laptop, Desktop, Monitors, Motherboards, & Gaming Accessories at Sri Computers, Pondicherry.
          </p>
          <div className="flex justify-center space-x-4 transform transition-all duration-1000 ease-out opacity-0 translate-y-8 animate-[fadeInUp_1s_0.8s_forwards]">
            <a 
              ...
              className="bg-white text-gray-800 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Shop Now
            </a>
            <a 
              href="tel:+919994678486"
              className="border-2 border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-800 transform hover:scale-105 transition-all duration-300 hover:shadow-lg"
            >
              Contact Us
            </a>
          </div>
      ...
      <div className="bg-white py-16 transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards]">
            <h2 className="text-5xl font-bold text-gray-800 mb-4 transition-colors duration-300 hover:text-gray-700">
              ASUS Laptops
            </h2>
            <h3 className="text-2xl font-semibold text-gray-700 mb-4 transition-colors duration-300">
              Most Searched ASUS Laptops in Pondicherry
            </h3>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto transition-colors duration-300">
              Here are some of the most wanted ASUS Laptops in Chennai. In our Store, you can find all kinds of ASUS laptops to fit your budget.
            </p>
          </div>
            ...
            {laptops.map((laptop, index) => (
              <div key={laptop.id} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 border border-gray-100 overflow-hidden group opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards]" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="w-full h-48 bg-gradient-to-br from-gray-200 to-gray-300 items-center justify-center group-hover:from-gray-300 group-hover:to-gray-400 transition-all duration-700 hidden">
                    <div className="text-gray-500 text-center">
                      <FaLaptop className="text-4xl mb-2 mx-auto transition-transform duration-300 group-hover:scale-110" />
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-gray-800 mb-3 group-hover:text-gray-700 transition-colors duration-300">
                    {laptop.name}
                  </h4>
                  
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center text-sm text-gray-700 transform transition-all duration-300 hover:translate-x-1">
                      <FaMicrochip className="w-4 h-4 mr-3 text-gray-600 transition-colors duration-300" />
      ...
      <div className="bg-gradient-to-r from-black to-gray-900 py-16 text-white transition-all duration-500">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h3 className="text-4xl font-bold mb-8 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards] transition-colors duration-300 hover:text-gray-200">Why Choose ASUS?</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              icon: FaLaptop,
              title: "ZenBook Excellence",
              description: "Premium ultrabooks combining elegant design with powerful performance for professionals."
            },
            {
              icon: FaDesktop,
              title: "ROG Gaming",
              description: "Republic of Gamers - cutting-edge gaming laptops built for esports champions."
            },
            {
              icon: FaTabletAlt,
              title: "VivoBook Versatility",
              description: "Reliable everyday laptops offering exceptional value and performance for all users."
            }
          ].map((item, index) => (
            <div key={index} className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm transform transition-all duration-500 hover:scale-105 hover:bg-white/20 opacity-0 translate-y-8 animate-[fadeInUp_0.8s_forwards]" style={{ animationDelay: `${index * 0.2}s` }}>
              ...
              <p className="text-gray-100 transition-colors duration-300">{item.description}</p>
            </div>
          ))}
        </div>
      </div>
